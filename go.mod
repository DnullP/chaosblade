...
// Normalize ugorji packages: map both import paths to the legacy codec module version
require github.com/ugorji/go/codec v1.2.9 // indirect

replace github.com/ugorji/go => github.com/ugorji/go/codec v0.0.0-20181204163529-d75b2dcb6bc8
